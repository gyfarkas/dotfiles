...
sy keyword hsStructure data family class where instance default deriving template with
...
sy keyword hsAsLabel qualified as contained
sy keyword hsHidingLabel hiding contained

sy match hsImportParams "\(qualified\s\+\)\?as\s\+\(\w\+\)" contained
